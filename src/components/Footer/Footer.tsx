...
const Footer = () => {
  const pages = [
    ...
    {
      text: "Environmental & Safety Practices",
      href: "/environmental-and-safety-practices",
    },
    { text: "Licensing & Insurance", href: "/licensing-and-insurance" },
    { text: "Pricing & Estimates", href: "/pricing-and-estimates" },
  ];
