...
const pricingData = [
  ...
  },
  {
    ...
    description: ["Includes kitchen, bathrooms, vacuuming, mopping, and surface disinfecting"],
    price: "$120 - $180",
  },
  {
    ...
    description: ["Baseboards, inside appliances, detailed sanitizing of all surfaces and rooms"],
    price: "$200+",
  },
];
...
const services = [
  {
    "title": "Deep Cleaning",
    "description": "A full-home refresh that tackles dirt, dust, and grime—even in the hardest-to-reach places. Perfect for move-ins, move-outs, or seasonal resets.",
    "emoji": "✨"
  },
  {
    "title": "Standard House Cleaning",
    "description": "Weekly, bi-weekly, or monthly service to keep your home looking, feeling, and smelling fresh all year round.",
    "emoji": "🧽"
  },
  {
    "title": "Carpet & Rug Cleaning",
    "description": "We remove stains, allergens, and pet odors using safe, professional-grade techniques that protect your carpet fibers.",
    "emoji": "🛋️"
  },
  {
    "title": "Bathroom & Kitchen Sanitization",
    "description": "High-touch surfaces, tiles, sinks, tubs, and appliances disinfected with industry-approved cleaners.",
    "emoji": "🚿"
  },
  {
    "title": "Window, Baseboard & Detail Cleaning",
    "description": "We go beyond the basics—cleaning trim, vents, baseboards, window sills, and behind furniture.",
    "emoji": "🪟"
  }
]
  ...
  return (
    <ThemeRegistry>
      ...
      <Container maxWidth="md">
        <TrustBadges title="INRI Paint & Wall" description="Professional Residential Cleaning Services in Garland, TX" />
        <Hero heroImage="/cleaning/hero.png" services="Professional Cleaning" />
        <ObjectionsBusters title="Now Offering Expert Home Cleaning Services – Because Clean Walls Deserve Clean Spaces" description="At INRI Paint & Wall, we’ve mastered the art of revitalizing homes with precision painting and expert drywall repairs. Now, we're bringing the same dedication and detail to residential cleaning services. Whether it’s your apartment, condo, or house, we make your home feel brand new—top to bottom." cards={cards} />
